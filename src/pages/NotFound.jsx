...
const NotFound = () => { // Declare the NotFound functional component
  return ( // Return the JSX to be rendered
    <div className="flex flex-col items-center justify-center h-full p-6 text-center bg-gray-50 dark:bg-gray-900 transition-colors duration-200"> {/* Centered flex container taking full height with padding */}
      <h1 className="text-6xl font-extrabold text-red-500 mb-4">404</h1> {/* Very large, extra bold, red heading displaying 404 */}
      <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-6">Page Not Found</h2> {/* Secondary heading stating the page is not found */}
      <p className="text-gray-600 dark:text-gray-400 mb-8">The page you are looking for doesn't exist or has been moved.</p> {/* Paragraph explaining the error with bottom margin */}
