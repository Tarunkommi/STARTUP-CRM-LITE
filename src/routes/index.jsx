...
import MobileHeader from '../components/common/MobileHeader'; // Import the MobileHeader
...
const AppRoutes = () => { // Define the AppRoutes functional component which will hold all route definitions
  return ( // Start returning the layout and routes
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900 font-sans text-gray-900 dark:text-gray-100 transition-colors duration-200 overflow-hidden">
      <MobileHeader />
      <Sidebar /> {/* Render the Sidebar component on the left side */}
      
      <main className="flex-1 overflow-y-auto relative pb-16 md:pb-0 pt-16 md:pt-0"> {/* Main content area: takes up remaining flex space, allows vertical scrolling if content overflows */}
